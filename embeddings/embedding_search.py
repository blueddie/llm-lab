...
텍스트: 고양이는 귀엽다
벡터 차원: 1536
앞 5개 값: [0.028470151126384735, -0.0010752398520708084, -0.0742846205830574, -0.011481712572276592, 0.008686205372214317]

=== 유사도 비교 ===

  0.3259  |  "고양이는 귀엽다" ↔ "강아지는 사랑스럽다"
  0.2069  |  "고양이는 귀엽다" ↔ "Python은 프로그래밍 언어다"
  0.2303  |  "오늘 날씨가 좋다" ↔ "햇살이 따뜻하다"
  0.1378  |  "오늘 날씨가 좋다" ↔ "주식이 폭락했다"

=== 유사도 검색 ===

질문: 휴가 며칠 쓸 수 있어?
  1. [0.4537] 경조사 휴가는 결혼 5일, 출산 10일, 사망 3일이 지급됩니다.
  2. [0.2874] 연차는 입사일 기준으로 매년 15일이 부여됩니다.
  3. [0.2483] 점심시간은 12시부터 1시까지이며, 자율적으로 조정 가능합니다.

질문: 재택근무 가능한가요?
  1. [0.4208] 원격 근무는 주 2회까지 가능하며, 팀장 승인이 필요합니다.
  2. [0.3369] 퇴직금은 근속 1년 이상 시 지급되며, 평균 임금 기준으로 산정됩니다.
  3. [0.3142] 야근 식대는 1만원까지 법인카드로 결제 가능합니다.

질문: 야근하면 밥값 나와?
  1. [0.378] 야근 식대는 1만원까지 법인카드로 결제 가능합니다.
  2. [0.1812] 퇴직금은 근속 1년 이상 시 지급되며, 평균 임금 기준으로 산정됩니다.
  3. [0.1667] 경조사 휴가는 결혼 5일, 출산 10일, 사망 3일이 지급됩니다.
